...
CSS = """
  ...
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  .btn-copy-url{background:#6b7280;color:#fff;border:none;padding:.6rem .9rem;border-radius:8px;font-weight:700;font-size:.88rem;cursor:pointer;transition:background .2s;white-space:nowrap;}
...
function copyUrlFromInput(){
  ...
  navigator.clipboard.writeText(url).then(() => {
    ...
    setTimeout(() => { btn.textContent = '📋 Copiar URL'; btn.classList.remove('copied'); }, 2500);
  }).catch(() => {
...
<div id="modal-url" class="img-modal-backdrop">
  <div class="img-modal">
    ...
    <div class="url-input-row">
      ...
      <button class="btn-copy-url" id="btn-copy-url" onclick="copyUrlFromInput()">📋 Copiar URL</button>
    </div>
